    ...
    ? ((n = require("jquery")),
      ...
      "undefined" != typeof window
        ? (module.exports = function (e, d) {
            return (
              (e = e || window), (d = d || n(e)), o(e, d), a(d, 0, e.document)
            );
          })
        : (o(window, n), (module.exports = a(n, window, window.document))))
      ...
      return function (e, d, a) {
        ...
        i.fn.modal
          ? d ||
            (t &&
              t.header &&
              ((o = (n = l.find("div.modal-header")).find("button").detach()),
              n
                .empty()
                .append('<h4 class="modal-title">' + t.header(e) + "</h4>")
                .prepend(o)),
